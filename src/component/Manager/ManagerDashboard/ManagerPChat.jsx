...
const ManagerPChat = () => {
  const data = [
    { type: 'Total Repair Application', value: 75 },
    { type: 'Complete Repair', value: 35 },
  ];
  ...
  return (
    <div style={{ backgroundColor: '#EEF9FE', padding: '0.2rem', borderRadius: '12px' }}>
      {/* Set the height here */}
