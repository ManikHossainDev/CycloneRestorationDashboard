...
const RestorationTaskDetails = () => {
  ...
  const data = {
    ...
    productDetails: "I've been affected by the storm and need help to recover. From shelter to supplies, I'm seeking support to rebuild my life.",
          ...
          <div className="lg:col-span-8 w-full space-y-6">
            ...
            <div className="bg-white rounded-lg md:p-4 ">
              <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-4">
                <div>
                  <p className="text-md font-bold text-gray-600">Restoration Title</p>
                  <p className="text-gray-900 font-medium">{data.restorationTitle}</p>
                </div>
                <div>
                  <p className="text-md font-bold text-gray-600">Restoration  Category</p>
                  <p className="text-gray-900 font-medium">{data.restorationCategory}</p>
                </div>
                <div>
                  <p className="text-md font-bold text-gray-600">Damage Severity Level</p>
                  <p className="text-red-600 font-medium">{data.damageSeverityLevel}</p>
                </div>
              </div>
            ...
            {/* Insurance Info */}
            <div className="bg-white rounded-lg p-4 sm:p-6 border-b-2">
              <h2 className="text-lg font-semibold mb-3">House Insurance Info</h2>
...
export default RestorationTaskDetails;
